...
const getFarmerSidebar = (farmer, activeRoute) => `
  <aside class="sidebar">
    ...
    <a class="nav-link ${activeRoute === 'dashboard' ? 'active' : ''}" onclick="routeTo('#farmer-dashboard')"><i class="fas fa-tachometer-alt"></i> Dashboard</a>
    <a class="nav-link ${activeRoute === 'smart-booking' ? 'active' : ''}" onclick="routeTo('#smart-booking')"><i class="fas fa-wand-magic-sparkles" style="color:var(--saffron);"></i> 🌾 Smart Mandi Finder</a>
    <a class="nav-link ${activeRoute === 'mandi-prices' ? 'active' : ''}" onclick="routeTo('#mandi-prices')"><i class="fas fa-carrot" style="color:var(--green-gov);"></i> 🥕 Mandi Live Prices</a>
    <a class="nav-link ${activeRoute === 'book-slot' ? 'active' : ''}" onclick="routeTo('#book-slot')"><i class="fas fa-calendar-plus"></i> Slot Booking</a>
    <a class="nav-link ${activeRoute === 'farmer-queue' ? 'active' : ''}" onclick="routeTo('#farmer-queue')"><i class="fas fa-users-line"></i> Live Queue Tracker</a>
    <a class="nav-link ${activeRoute === 'my-bookings' ? 'active' : ''}" onclick="routeTo('#my-bookings')"><i class="fas fa-ticket-alt"></i> My Bookings</a>
    <a class="nav-link ${activeRoute === 'farmer-payments' ? 'active' : ''}" onclick="routeTo('#farmer-payments')"><i class="fas fa-money-check-dollar"></i> DBT Payment Tracker</a>
