...
const cropProfiles = {
  ...
  onion: {
    ...
    badge: "🟠 Medium Perishable",
    badgeClass: "waiting",
    badgeDescription: "Adequate ventilation required to prevent moisture rotting during transit.",
    baseDeteriorationRate: 0.005,
    humiditySensitivity: 0.18,
    temperatureSensitivity: 0.12,
    rainSensitivity: 0.06,
    delayCostPerQuintalPerDay: 4.5,
    optimalTemperatureMin: 15,
    optimalTemperatureMax: 28,
    defaultPrice: 1950,
    baseMsp: 1950,
  ...
  peas: {
    name: "Green Peas",
    displayName: "Green Peas (हरी मटर)",
    cropType: "vegetable",
    category: "high",
    perishabilityLevel: "HIGH PERISHABILITY",
    badge: "🔴 High Perishable",
    badgeClass: "skipped",
    badgeDescription: "Highly perishable tender crop. Immediate mandi delivery recommended.",
    baseDeteriorationRate: 0.022,
    humiditySensitivity: 0.24,
    temperatureSensitivity: 0.20,
    rainSensitivity: 0.09,
    delayCostPerQuintalPerDay: 14,
    optimalTemperatureMin: 10,
  ...
  cauliflower: {
    name: "Cauliflower",
    displayName: "Cauliflower (फूलगोभी)",
    cropType: "vegetable",
    category: "high",
    perishabilityLevel: "HIGH PERISHABILITY",
    badge: "🔴 High Perishable",
    badgeClass: "skipped",
    badgeDescription: "Susceptible to heat browning and moisture loss. Rapid transit needed.",
    baseDeteriorationRate: 0.020,
    humiditySensitivity: 0.22,
    temperatureSensitivity: 0.19,
    rainSensitivity: 0.10,
    delayCostPerQuintalPerDay: 12,
    optimalTemperatureMin: 12,
    optimalTemperatureMax: 24,
    defaultPrice: 1650,
    baseMsp: 1650,
  ...
  cotton: {
    ...
    badge: "🟠 Medium Perishable",
    badgeClass: "waiting",
    badgeDescription: "Protect from high humidity and rain to preserve fiber grade & luster.",
    baseDeteriorationRate: 0.002,
    humiditySensitivity: 0.15,
    temperatureSensitivity: 0.05,
  ...
  groundnut: {
    ...
    badge: "🟢 Low Perishable",
    badgeClass: "completed",
    badgeDescription: "Dry pods offer good shelf endurance under standard storage conditions.",
    baseDeteriorationRate: 0.0015,
    humiditySensitivity: 0.12,
    temperatureSensitivity: 0.06,
    rainSensitivity: 0.04,
    delayCostPerQuintalPerDay: 2.8,
    optimalTemperatureMin: 18,
    optimalTemperatureMax: 30,
    defaultPrice: 6783,
    baseMsp: 6783,
  ...
  banana: {
    name: "Banana",
    displayName: "Banana (केला)",
    cropType: "fruit",
    category: "high",
    perishabilityLevel: "HIGH PERISHABILITY",
    badge: "🔴 High Perishable",
    badgeClass: "skipped",
    badgeDescription: "Rapid ripening curve. Requires prompt harvest offloading and sale.",
    baseDeteriorationRate: 0.024,
    humiditySensitivity: 0.25,
    temperatureSensitivity: 0.22,
    rainSensitivity: 0.08,
    delayCostPerQuintalPerDay: 15,
    optimalTemperatureMin: 15,
    optimalTemperatureMax: 28,
  ...
  apple: {
    name: "Apple",
    displayName: "Apple (सेब)",
    cropType: "fruit",
    category: "medium",
    perishabilityLevel: "MEDIUM PERISHABILITY",
    badge: "🟠 Medium Perishable",
    badgeClass: "waiting",
    badgeDescription: "Firm fruit with moderate storage endurance in ventilated cool packaging.",
    baseDeteriorationRate: 0.006,
    humiditySensitivity: 0.16,
    temperatureSensitivity: 0.14,
    rainSensitivity: 0.05,
    delayCostPerQuintalPerDay: 6.0,
    optimalTemperatureMin: 2,
    optimalTemperatureMax: 18,
    defaultPrice: 7200,
    baseMsp: 7200,
  ...
  mango: {
    name: "Mango",
    displayName: "Mango (आम)",
    cropType: "fruit",
    category: "high",
    perishabilityLevel: "HIGH PERISHABILITY",
    badge: "🔴 High Perishable",
    badgeClass: "skipped",
    badgeDescription: "Climacteric fruit with short post-harvest shelf life at room temperature.",
    baseDeteriorationRate: 0.022,
    humiditySensitivity: 0.22,
    temperatureSensitivity: 0.21,
    rainSensitivity: 0.07,
    delayCostPerQuintalPerDay: 14,
    optimalTemperatureMin: 18,
    optimalTemperatureMax: 30,
    defaultPrice: 3400,
  ...
  orange: {
    name: "Orange",
    displayName: "Orange (संतरा)",
    cropType: "fruit",
    category: "high",
    perishabilityLevel: "HIGH PERISHABILITY",
    badge: "🔴 High Perishable",
    badgeClass: "skipped",
    badgeDescription: "Citrus fruit susceptible to moisture loss & fungal decay if delayed.",
    baseDeteriorationRate: 0.015,
    humiditySensitivity: 0.20,
    temperatureSensitivity: 0.18,
    rainSensitivity: 0.06,
    delayCostPerQuintalPerDay: 10,
    optimalTemperatureMin: 8,
    optimalTemperatureMax: 24,
    defaultPrice: 3100,
    baseMsp: 3100,
